...
<body>
  <div class="container">
    ...
    <div class="Busqueda" style="text-align: center; margin-top: 20px;">
      <h1 class="main-title" style="max-width: 600px; margin: 0 auto;">Añadir alimento a Cena</h1>
...
function buscarAlimento() {
  ...
  xhr.open('GET', 'RegistroCena.php?searchTerm=' + searchTerm, true);
  xhr.onload = function() {
    if (xhr.status === 200) {
...
alimentosSeleccionadosCena.push(alimentoSeleccionado);
